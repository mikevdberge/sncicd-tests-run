...
const getFullUrl = (props: AppProps, inputs: any) =>
    `https://${props.instance}/api/sn_cicd/testsuite/run?test_suite_sys_id=${inputs.test_suite_sys_id}&test_suite_name=${inputs.test_suite_name}&browser_name=${inputs.browser_name}&browser_version=${inputs.browser_version}&os_name=${inputs.os_name}&os_version=${inputs.os_version}`
...
describe(`App lib`, () => {
    ...
    beforeEach(() => {
        props = { password: 'test', instance: 'test', username: 'test', apikey: 'test' }
    })
